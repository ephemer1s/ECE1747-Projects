...
maze myMaze;
int DEPTH = 1; // recursive depth, TODO: make this a arg
int MAX_THREADS = 4 * DEPTH;
...
int main()
{
	...
	// int bfDistance = bruteForceMazeSolver(x,y);  // version sequential
...
int bruteForceMazeSolver(int i, int j) // This should be what each thread does
{
